...
| `reader.rabbitmq.exchangeBindingName`               | RabbitMQ reader external exchange name to bind to                                         | `""`                               |
| `reader.rabbitmq.exchangeBindingKey`                | RabbitMQ reader binding key for external                                                  | `""`                               |
